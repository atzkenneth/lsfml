...
# -*- coding: utf-8
#
#  Original Paper: The global Graph Multiset Transformer pooling operator from the "Accurate Learning
#  of Graph Representations with Graph Multiset Pooling" <https://arxiv.org/abs/2102.11533>`.
#  Code adapted from PyTorch Geometric:
#  https://pytorch-geometric.readthedocs.io/en/2.0.3/_modules/torch_geometric/nn/glob/gmt.html
